...
public class ApplicationNotificationSentToCpsResponseTransformer extends ResponseDefinitionTransformer {

    public static final Logger LOGGER = LoggerFactory.getLogger(ApplicationNotificationSentToCpsResponseTransformer.class);

    public static final String APPLICATION_NOTIFICATION_SENT_TO_CPS_RESPONSE_TRANSFORMER = "application-notification-sent-to-cps-response-transformer";
    ...
    public String getName() {
        return APPLICATION_NOTIFICATION_SENT_TO_CPS_RESPONSE_TRANSFORMER;
    }
    ...
    private String extractApplicationId(final String jsonPayload) {
        ...
        return payloadAsJsonObject.getJsonObject("applicationNotification").getString("applicationId");
    }
}
