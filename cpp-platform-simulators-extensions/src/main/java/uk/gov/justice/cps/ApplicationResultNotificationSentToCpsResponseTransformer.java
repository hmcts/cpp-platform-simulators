...
public class ApplicationResultNotificationSentToCpsResponseTransformer extends ResponseDefinitionTransformer {

    public static final Logger LOGGER = LoggerFactory.getLogger(ApplicationResultNotificationSentToCpsResponseTransformer.class);

    public static final String APPLICATION_RESULT_NOTIFICATION_SENT_TO_CPS_RESPONSE_TRANSFORMER = "application-result-notification-sent-to-cps-response-transformer";
    ...
    public String getName() {
        return APPLICATION_RESULT_NOTIFICATION_SENT_TO_CPS_RESPONSE_TRANSFORMER;
    }
    ...
    private String extractApplicationId(final String jsonPayload) {
        ...
        return payloadAsJsonObject.getJsonObject("applicationResultNotification").getString("applicationId");
    }
}
