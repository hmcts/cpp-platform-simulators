...
import static uk.gov.justice.cps.ApplicationNotificationSentToCpsResponseTransformer.APPLICATION_NOTIFICATION_SENT_TO_CPS_RESPONSE_TRANSFORMER;
...
public class ApplicationNotificationSentToCpsResponseTransformerTest {

    private static final String CPS_NOTIFICATION_PATH = "/CP/v1/notification/appliication-notification";

    @Rule
    public WireMockRule wireMockRule = new WireMockRule(options().port(8888).extensions(ApplicationNotificationSentToCpsResponseTransformer.class));
    ...
    public void setupTest() throws IOException {
        ...
        wireMockRule.stubFor(post(urlPathEqualTo(CPS_NOTIFICATION_PATH))
                .willReturn(aResponse()
                        .withTransformer(APPLICATION_NOTIFICATION_SENT_TO_CPS_RESPONSE_TRANSFORMER, null, null)
                ));
    }
    ...
    public void shouldReturnValidResponseForMultipartRequest() throws IOException {
        ...
        mdo.addFormData("Notification", FileUtils.openInputStream(new File("src/test/resources/sample/application-notification.json")),
                MediaType.APPLICATION_JSON_TYPE, "application-notification.json");
    ...
    private JsonObject getPayload(final String applicationId) {
        ...
        return createObjectBuilder().add("applicationNotification", applicationNotification).build();
    }
